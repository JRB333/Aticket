...
public class Defines {
    ...
    public static final String SurveyMenu = "SURVEY";
    public static final String PermitHistoryMenu = "PERMHIST";   // JRB Added 3-22-16
  ...
  //'416+ whatever
    ...
    public static final String CustomRoutineDoneVal = "432";
    public static final String CustomIPAddress = "433";   // ParkMobile, PayByPhone, etc. IP Address

    public static final String ParkMobile = "441";
    public static final String ParkMobile_Username = "442";
    public static final String ParkMobile_Password = "443";

    public static final String TxfrPlateVal = "450";
    public static final String TxfrStateVal = "451";
    public static final String TxfrDirVal = "452";
    public static final String TxfrDirCodeVal = "453";
    public static final String TxfrNumVal = "454";
    public static final String TxfrStreetVal = "455";
    public static final String TxfrChalkTime = "456";
    public static final String TxfrSpace = "457";
    public static final String ReturnToChalk = "458";

    public static final String PlateRepeat = "460";
    public static final String PreviousMenu = "461";

    public static final String CaptureSignature = "470";
    public static final String SignatureFile = "471";

    //The following is to support SURVEY
    public static final String ReturnToSurvey = "480";
    public static final String SurveyOption = "481";
    public static final String FileDir = "482";
    public static final String ChkRouteName = "483";
    public static final String RouteName = "484";
    public static final String RouteItemCount = "485";
    public static final String StreetName = "486";
    public static final String MeterSpace = "487";
    public static final String PassCounter = "488";
    public static final String PassItemCounter = "489";
    public static final String ItemsRetrieved = "490";
    public static final String LastUpdate = "491";
    public static final String SurveyPlate = "492";
    public static final String SurveyState = "493";
    public static final String ResumeRoute = "494";
    public static final String ResumeItemCounter = "495";
    public static final String ResumePassItemCounter = "496";
    public static final String RouteSequence = "497";
    public static final String IntegrateSurveyData = "498";
    public static final String RefreshCalledBy = "499";
    public static final String LastSurveyListItemCounter = "500";

    public static final String HonorTicketIssued = "501";
    public static final String ReprintHonorTicket = "502";
    public static final String PreviousClientName = "503";
    public static final String NewClientName = "504";
    public static final String SavingTickFile = "505";
}
