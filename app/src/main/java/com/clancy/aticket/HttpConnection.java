...
public class HttpConnection implements Runnable {
    ...
    private static final int POSTBITMAP = 5;
    ...
    public void postBitmap(String url, String data, byte[] byteBuffer, String fileName) {
        create(POSTBITMAP, url, data, byteBuffer, fileName);
    }
    ...
    public void run() {
        ...
        try {
            ...
            switch (method) {
                ...
                /*if (WorkingStorage.GetCharVal(Defines.UploadIPAddress, Defines.contextGlobal).substring(0,11).equals("107.1.38.45"))
                {
                    httpPost.setHeader("Authorization", "Basic "+Base64.encodeToString(WorkingStorage.GetCharVal(Defines.MobilePutDelVal, Defines.contextGlobal).getBytes(), Base64.NO_WRAP));
                }*/
                ...
                case POSTBITMAP:
                    ...
                    if (WorkingStorage.GetCharVal(Defines.UploadIPAddress, Defines.contextGlobal).substring(0,11).equals("107.1.38.45"))
                    {
                        httpPostBitmap.setHeader("Authorization", "Basic "+Base64.encodeToString(WorkingStorage.GetCharVal(Defines.MobilePutDelVal, Defines.contextGlobal).getBytes(), Base64.NO_WRAP));
                    }
                    httpPostBitmap.setEntity(new ByteArrayEntity(byteBuffer));
