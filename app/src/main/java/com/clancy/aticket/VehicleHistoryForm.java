...
public class VehicleHistoryForm extends ActivityGroup {
	...
	public static String PrintVehicleHistory(Context cntxt, OutputStream outputStream)
	{
		String PrintCompleteTicket = "";
		String ParseString = "";
		String ReturnMessage = "";
		ReturnMessage = HTTPFileTransfer.HTTPGetPageContent("http://"+WorkingStorage.GetCharVal(Defines.UploadIPAddress, cntxt)+"/lookup.asp?plate=" + WorkingStorage.GetCharVal(Defines.PrintPlateVal,cntxt) + "&status=OPEN&lp=PRINT", cntxt);
		try {
		...
		ReadLayout.PrintThisTrimmed(WorkingStorage.GetCharVal(Defines.PrintPlateVal, cntxt), outputStream);
	  ...
	  public void onCreate(Bundle savedInstanceState) {
		...
		if (WorkingStorage.GetCharVal(Defines.MenuProgramVal, getApplicationContext()).contains("VHISTORY"))
		{
			TextView functionLabel = (TextView) findViewById(R.id.functionLabel);
			functionLabel.setText("Veh History " );
