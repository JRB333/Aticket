...
public class AdditionalComment3Form extends ActivityGroup {

	  private void EnterClick()
	  {
		  EditText comment = (EditText) findViewById(R.id.editTextcomment);   
		  String newString = comment.getText().toString();		  
	      WorkingStorage.StoreCharVal(Defines.PrintAdditionalComment3Val, newString,getApplicationContext());	     
	  ...
	  public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addcomment3form);
